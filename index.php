  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .search-input {
      ...
      font-family: 'Kanit'; font-size: 1em; background: #f9fbfc; transition: 0.3s;
      cursor: text;
    }
...
<div class="container">
  ...
  <div class="left-panel">
    <header>
      <h1>PokéCatch Sim</h1>
      <p class="subtitle">ระบบคำนวณโอกาสจับโปเกมอน</p>
    </header>
    ...
    <div class="poke-display">
      ...
      <div class="search-wrapper">
        <input type="text" id="poke-search" class="search-input" placeholder="พิมพ์ชื่อ..." disabled autocomplete="off">
        <div class="dropdown-arrow" id="toggle-arrow">▼</div>
        <ul id="suggestions" class="suggestions-list"></ul>
      </div>
      <div style="font-size:0.8em; color:#a0aec0; margin-top:5px;">
        เรท: <span id="cr-display" style="color:var(--text-dark)">190</span> | น้ำหนัก: <span id="weight-display" style="color:var(--text-dark)">6.0</span>kg
      </div>
    </div>

    <div class="result-section">
      <div class="percentage" id="result-percent">0<span>%</span></div>
      <button class="sim-btn" id="btn-throw">ทดลองปาบอล</button>
    </div>
  </div>

  <div class="right-panel">
    <div class="tabs-nav">
      <button class="tab-btn active" onclick="switchTab('basic')">พื้นฐาน</button>
      <button class="tab-btn" onclick="switchTab('tech')">เทคนิค</button>
      <button class="tab-btn" onclick="switchTab('special')">เฉพาะทาง</button>
      <button class="tab-btn" onclick="switchTab('cosmetic')">สวยงาม</button>
    </div>

    <div id="grid-basic" class="grid-options-balls active">
      <label class="radio-card" data-tooltip="บอลมาตรฐานสำหรับจับโปเกมอน (x1)"><input type="radio" name="ball" value="poke" checked data-img="poke-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/poke-ball.png" class="ball-icon"><div style="font-size:0.7em">Poké Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่มีประสิทธิภาพดีกว่า Poké Ball (x1.5)"><input type="radio" name="ball" value="great" data-img="great-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/great-ball.png" class="ball-icon"><div style="font-size:0.7em">Great Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่มีประสิทธิภาพสูงมาก (x2)"><input type="radio" name="ball" value="ultra" data-img="ultra-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/ultra-ball.png" class="ball-icon"><div style="font-size:0.7em">Ultra Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่จับโปเกมอนได้แน่นอน 100% โดยไม่มีเงื่อนไข"><input type="radio" name="ball" value="master" data-img="master-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/master-ball.png" class="ball-icon"><div style="font-size:0.7em; color:purple">Master Ball</div></div></label>
    </div>

    <div id="grid-tech" class="grid-options-balls">
      <label class="radio-card" data-tooltip="บอลที่จับง่ายมากหากใช้ในเทิร์นแรกของการต่อสู้ (x5)"><input type="radio" name="ball" value="quick" data-img="quick-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/quick-ball.png" class="ball-icon"><div style="font-size:0.7em">Quick Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่จับง่ายในเวลากลางคืน หรือในถ้ำ (x3)"><input type="radio" name="ball" value="dusk" data-img="dusk-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/dusk-ball.png" class="ball-icon"><div style="font-size:0.7em">Dusk Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่มีประสิทธิภาพสูงขึ้นตามจำนวนเทิร์นที่ผ่านไป (สูงสุด x4)"><input type="radio" name="ball" value="timer" data-img="timer-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/timer-ball.png" class="ball-icon"><div style="font-size:0.7em">Timer Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่จับง่ายขึ้น 3.5 เท่า ถ้าเป้าหมายเป็นธาตุน้ำ (Water) หรือแมลง (Bug)"><input type="radio" name="ball" value="net" data-img="net-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/net-ball.png" class="ball-icon"><div style="font-size:0.7em">Net Ball</div></div></label>
    </div>

    <div id="grid-special" class="grid-options-balls">
      <label class="radio-card" data-tooltip="บอลสำหรับจับโปเกมอนที่มีน้ำหนักตัวมาก (ยิ่งหนักยิ่งจับง่าย)"><input type="radio" name="ball" value="heavy" data-img="heavy-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/heavy-ball.png" class="ball-icon"><div style="font-size:0.7em">Heavy Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่จับง่ายขึ้นถ้าโปเกมอนของเรามีเลเวลสูงกว่าศัตรู"><input type="radio" name="ball" value="level" data-img="level-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/level-ball.png" class="ball-icon"><div style="font-size:0.7em">Level Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่จับง่ายมาก (x8) ถ้าเป้าหมายเป็นเพศตรงข้ามและชนิดเดียวกัน"><input type="radio" name="ball" value="love" data-img="love-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/love-ball.png" class="ball-icon"><div style="font-size:0.7em">Love Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่จับง่ายขึ้นถ้าเป้าหมายมีความเร็วสูง (Speed >= 100)"><input type="radio" name="ball" value="fast" data-img="fast-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/fast-ball.png" class="ball-icon"><div style="font-size:0.7em">Fast Ball</div></div></label>
    </div>

    <div id="grid-cosmetic" class="grid-options-balls">
      <label class="radio-card" data-tooltip="บอลหรูหรา จับแล้วโปเกมอนจะเชื่องไวขึ้น (จับยากเท่า Poké Ball)"><input type="radio" name="ball" value="luxury" data-img="luxury-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/luxury-ball.png" class="ball-icon"><div style="font-size:0.7em">Luxury Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลพิเศษสีขาว สำหรับฉลองโอกาสพิเศษ (จับยากเท่า Poké Ball)"><input type="radio" name="ball" value="premier" data-img="premier-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/premier-ball.png" class="ball-icon"><div style="font-size:0.7em">Premier Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่จับแล้วช่วยฟื้นเลือดและสถานะให้โปเกมอนทันที (จับยากเท่า Poké Ball)"><input type="radio" name="ball" value="heal" data-img="heal-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/heal-ball.png" class="ball-icon"><div style="font-size:0.7em">Heal Ball</div></div></label>
      <label class="radio-card" data-tooltip="บอลที่จับง่ายถ้าเป้าหมายมีเลเวลต่ำ (จับเลเวลสูงๆ ยาก)"><input type="radio" name="ball" value="nest" data-img="nest-ball"><div class="card-content"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/nest-ball.png" class="ball-icon"><div style="font-size:0.7em">Nest Ball</div></div></label>
    </div>

    <div id="context-panel" class="context-panel">
      <span class="context-msg">เลือกบอลด้านบนเพื่อปรับแต่ง</span>
    </div>

    <div>
      <div class="section-label">สถานะ (Status)</div>
      <div class="status-grid">
        <label class="radio-card" data-tooltip="ไม่มีสถานะผิดปกติ"><input type="radio" name="status" value="1" checked><div class="card-content" style="height:50px"><div style="font-size:1.2em">⚪</div><div style="font-size:0.7em">Normal</div></div></label>
        <label class="radio-card" data-tooltip="ติดสถานะ : ชา (Paralysis) / ไหม้ (Burn) / พิษ (Poison)"><input type="radio" name="status" value="1.5"><div class="card-content" style="height:50px"><div class="status-icon-group"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/paralyze-heal.png" class="status-icon"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/burn-heal.png" class="status-icon"></div><div style="font-size:0.7em">x1.5</div></div></label>
        <label class="radio-card" data-tooltip="ติดสถานะ : หลับ (Sleep) / แข็ง (Freeze)"><input type="radio" name="status" value="2.5"><div class="card-content" style="height:50px"><div class="status-icon-group"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/ice-heal.png" class="status-icon"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/awakening.png" class="status-icon"></div><div style="font-size:0.7em">x2.5</div></div></label>
      </div>
    </div>
    ...
    <div class="footer-tip" id="random-tip">💡 Tip: ...</div>
  </div>
...
// --- AUDIO SYSTEM ---
// ให้สร้างโฟลเดอร์ "sounds" แล้วเอาไฟล์ throw.mp3, hit.mp3, shake.mp3, catch.mp3, escape.mp3 ใส่ลงไป
const sounds = {
...
// Random Tips
const tips = [
  '💡 Tip: ใช้ท่า "False Swipe" ให้เหลือ 1 HP เพื่อโอกาสสูงสุด',
  '💡 Tip: สถานะ "หลับ (Sleep)" และ "แข็ง (Freeze)" เพิ่มโอกาสจับ 2.5 เท่า!',
  '💡 Tip: "Quick Ball" ในเทิร์นแรกดีที่สุด (x5) หากพลาดให้ลอง "Dusk Ball" ตอนกลางคืน',
  '💡 Tip: "Timer Ball" จะเก่งที่สุดหลังผ่านไป 10 เทิร์น (x4)',
  '💡 Tip: การกดปุ่มรัวๆ ไม่ช่วยให้จับง่ายขึ้นนะ (แต่ช่วยทางใจ!)',
  '💡 Tip: โปเกมอน "Water/Bug" แพ้ทาง "Net Ball" มาก (x3.5)',
  '💡 Tip: หากเลเวลเราสูงกว่าศัตรูมากๆ "Level Ball" อาจดีกว่า Ultra Ball'
];
...
// --- CORE CALCULATION VIA PHP ---
// ฟังก์ชันนี้ถูกเปลี่ยนให้ส่งข้อมูลไป PHP แทนการคิดเอง
async function calculate() {
  try {
    ...
    const payload = {
        hp: hp,
        ball: window.currentBall,
        status: parseFloat(statusEl.value),
        baseRate: window.currentBaseRate,
        weight: window.currentWeight,
        speed: window.currentSpeed,
        types: window.currentTypes,
        // Context variables
        turn: parseInt(document.getElementById('turn-count')?.value) || 1,
        isDark: document.getElementById('is-dark')?.checked || false,
        isTurnOne: document.getElementById('is-turn-one')?.checked || false,
        isLove: document.getElementById('is-love')?.checked || false,
        myLvl: parseInt(document.getElementById('my-lvl')?.value) || 50,
        enLvl: parseInt(document.getElementById('enemy-lvl')?.value) || 50
    };
    ...
    if (data && data.probability !== undefined) {
        window.currentProbability = data.probability;
        document.getElementById('result-percent').innerHTML = data.probability.toFixed(1) + '<span>%</span>';
    }
...
window.updateContextPanel = function(ballType) {
  ...
  if (ballType === 'quick') html = `<div class="input-group"><label>เทิร์นแรกใช่ไหม ?</label><label class="toggle-switch"><input type="checkbox" id="is-turn-one" onchange="calculate()"><span class="slider"></span></label></div>`;
  else if (ballType === 'timer') html = `<div class="input-group"><label>เทิร์นที่:</label><input type="number" id="turn-count" class="tiny-input" value="1" min="1" max="50" oninput="calculate()"></div>`;
  else if (ballType === 'dusk') html = `<div class="input-group"><label>กลางคืน/ในถ้ำ ใช่ไหม ?</label><label class="toggle-switch"><input type="checkbox" id="is-dark" onchange="calculate()"><span class="slider"></span></label></div>`;
  else if (ballType === 'level') html = `<div class="input-group"><label>เลเวลของเรา:</label><input type="number" id="my-lvl" class="tiny-input" value="50" oninput="calculate()"></div><div class="input-group"><label>เลเวลเป้าหมาย:</label><input type="number" id="enemy-lvl" class="tiny-input" value="50" oninput="calculate()"></div>`;
  else if (ballType === 'love') html = `<div class="input-group"><label>เพศตรงข้ามใช่ไหม ?</label><label class="toggle-switch"><input type="checkbox" id="is-love" onchange="calculate()"><span class="slider"></span></label></div>`;
  else if (ballType === 'heavy') html = `<span class="context-msg">⚖️ น้ำหนัก: ${window.currentWeight}kg</span>`;
  else if (ballType === 'fast') html = `<span class="context-msg">💨 ความเร็ว: ${window.currentSpeed}</span>`;
  else if (ballType === 'net') {
    const isTarget = window.currentTypes.includes('water') || window.currentTypes.includes('bug');
    html = isTarget ? `<span class="context-msg" style="color:var(--hp-green); font-weight:bold">✅ เป้าหมาย (x3.5)</span>` : `<span class="context-msg">❌ ไม่ใช่เป้าหมาย (x1)</span>`;
  }
  else html = `<span class="context-msg">ไม่มีเงื่อนไขพิเศษ</span>`;
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    searchInput.placeholder = "พิมพ์ชื่อ...";
    calculate(); 
  } catch (e) { console.error(e); }
  ...
  function updateSuggestions(val, forceShowAll) {
    ...
    let matches = [];
    if (forceShowAll) matches = window.allPokemonNames; 
    else if (val) matches = window.allPokemonNames.filter(n => n.startsWith(val.toLowerCase()));
    else { suggestionsList.classList.remove('active'); return; }
    ...
    if (matches.length > 0) {
      ...
      renderList.forEach(match => {
        ...
        li.onclick = () => { window.fetchPokemonData(match); suggestionsList.classList.remove('active'); };
  ...
  btnThrow.addEventListener('click', () => {
    ...
    animText.textContent = "ปาบอลไปแล้ว!";
    ...
    const doShake = (count, max) => {
        if (count > max) {
            if (success) {
                playSound('catch');
                animText.innerHTML = '<span style="color:#4bc05b">✨ จับสำเร็จ! ✨</span>';
                ...
                playSound('escape');
                animText.innerHTML = '<span style="color:#ff5040">💢 โปเกมอนหนีไปได้!</span>';
                animBallContainer.innerHTML = `<div style="font-size:3em;">💥</div>`;
            }
